...
Gig.create(
  ...
  time_period: 'Oct 2004-Sept 2005',
  additional_notes: nil,
...
Gig.create(
  ...
  position: 'Freelancer',
  img_url: nil,
  description: "Even when I had full-time jobs, I was still writing and editing on the side. Gaps in my resume between affiliated work were covered with freelancing. This is where I discovered I love diverse, distributed teams",
